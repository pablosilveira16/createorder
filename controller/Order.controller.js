	...
	return BaseController.extend("com.blueboot.createorder.controller.Order", {
		...
		onOrderCreate: function () {
			...
			/*try {*/
				...
				if (!order.Equipment || !order.OrderType || !order.Priority || !order.OrderAddress.Name
					|| !order.OrderAddress.Area || !order.OrderAddress.Record || !order.OrderAddress.Telephone) {
